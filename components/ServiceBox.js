...
function ServiceBox({ title, content, list, numberOfItems, link }) {
  return (
    <div
      className="hover-js border-t border-[#7D7D7D] pl-[0] md:pl-[50px] lg:pl-[80px] pt-[60px] pb-[100px] flex xl:space-x-[220px] flex-col xl:flex-row xl:items-center hover:opacity-75 transition duration-300 space-y-[20px] xl:space-y-[0px]"
      data-image-src="view"
    >
      <div>
