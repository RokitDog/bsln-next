...
function ServiceBox({ title, content, list, numberOfItems }) {
  return (
    <div
      className="hover-js border-t border-[#7D7D7D] pl-[80px] pt-[60px] pb-[100px] flex space-x-[220px] items-cente hover:opacity-75 transition duration-300"
      data-image-src="view"
    >
      <div>
      ...
      <div className="flex justify-between grow ">
        <div className="flex-[50]">
          <ul className="font-medium space-y-[15px] text-[15px] md:text-[20px]">
            {list.map((item, i) => {
