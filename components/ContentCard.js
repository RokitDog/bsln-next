...
function ContentCard({ name, content, hoverText }) {
  return (
    <div className="xl:flex-[33%] lg:flex-shrink-0 lg:flex-grow-0 lg:max-w-[33%] mb-[45px] services-cards opacity-0 translate-y-[50px] md:flex-[50%] lg:flex-[33%] relative overflow-hidden h-[347px]">
      <div className="bg-[#EDEDED] lg:p-[30px] absolute left-0 top-[100%] w-[90%] rounded-[20px] ">
        <h4 className="font-medium text-[20px] md:text-[24px] mb-[20px]">
          {name}
        </h4>
        <p className="mb-[30px]">{hoverText}</p>
